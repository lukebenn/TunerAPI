...
Everything is now set and you are ready to run any of the commands found in the \mbox{\hyperlink{class_tuner}{Tuner}} class.\hypertarget{index_Debugging}{}\doxysection{Debugging}\label{index_Debugging}
...
Will allow you to run the program without interfacing with the device. The intention is to allow you to easily modify the buffers and see them change with not device connected.\hypertarget{index_Need}{}\doxysection{Need a working example?}\label{index_Need}
