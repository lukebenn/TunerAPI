...
This is an C++ A\+PI for operating the R\+D\+A5807M FM chip using I2C on an L\+P\+C802 M\+CU\hypertarget{index_Prerequisites}{}\doxysection{Prerequisites}\label{index_Prerequisites}
To use this file on other project you need the following\+: ~\newline

\begin{DoxyItemize}
\item L\+P\+C802 M\+CU ~\newline

\item M\+C\+Uxpresso Version X\+X.\+XX ~\newline
